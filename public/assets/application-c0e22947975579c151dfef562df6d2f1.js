...
(function() {
  ...
  $(function() {
    var app_id, is_hate, is_like, urlnow;
    app_id = $("#app-id").text();
    ...
    $(".sb-tag").click(function() {
      ...
      return $('.ptag').append("<a href=\"/tags/" + tag_name + "\">" + tag_name + "</a>");
    });
    ...
    $("#likeable").click(function() {
      ...
      if ($("#is-like").text() === "0") {
        $("#is-like").text(1);
        return $("#likeable").html("<img src=\"/assets/unlike.png\"><span>Cancel</span>");
      } else if ($("#is-like").text() === "1") {
        $("#is-like").text(0);
        return $("#likeable").html("<img src=\"/assets/like.png\"><span>Like It</span>");
      }
    });
    ...
    return $("#hateable").click(function() {
      $.ajax({
        url: "/hate",
        type: "POST",
        data: {
      ...
      if (urlnow === "/guess") {
        return window.location.href = "/guess";
      }
    });
  });
...
-1;c.cookie&&a._cookie(c.selected,c.cookie);a.element.queue("tabs",function(){s(g,i)}).dequeue("tabs");this.blur();return false}else if(!i.length){c.cookie&&a._cookie(c.selected,c.cookie);a.element.queue("tabs",function(){r(g,l)});a.load(a.anchors.index(this));this.blur();return false}c.cookie&&a._cookie(c.selected,c.cookie);if(l.length){i.length&&a.element.queue("tabs",function(){s(g,i)});a.element.queue("tabs",function(){r(g,l)});a.load(a.anchors.index(this))}else throw"jQuery UI Tabs: Mismatch
;
/*
